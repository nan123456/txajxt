...
<?php
	...
	</td><td width=529  valign=top  colspan=6  style="width:396.9000pt;padding:0.0000pt 5.4000pt 0.0000pt 5.4000pt ;border-left:none;;mso-border-left-alt:none;;border-right:1.0000pt solid windowtext;mso-border-right-alt:0.5000pt solid windowtext;border-top:none;;mso-border-top-alt:0.5000pt solid windowtext;border-bottom:1.0000pt solid windowtext;mso-border-bottom-alt:0.5000pt solid windowtext;" >
...
//          }
		...
		<?php
		   if ($dx<10){
			 $y=38-($sum1+$sum2);
            	for($z=0;$z<$y;$z++){
            		echo '<p class=MsoNormal  align=center  style="text-align:center;margin:0px;" >&nbsp;空格5</p>';
            }
		    }
		    if($sum1+$sum2>40){
		    	echo "<script>alert('数据过多！！！')</script>";
