    				...
    				<ul class="nav bs-docs-sidenav">
    					...
    					<li>
    						...
    						<ul class="nav">
    							...
    							<li class="active" ><a href="ryqd.php?id=<?php echo $row["id"];?>&yhid=<?php echo $yhid ;?>">人员签到</a></li>
                     ...
                     <div class="input-prepend input-group">
                       ...
                       <input type="text" style="width: 200px" id="endtime" name="endtime" class="form-control hidden" value="2017-01-31"/>
						...
						//				$sql = "select * from 人员签到  where id='$id' ";
										$sql = "select * from 人员签到 where 签到时间 between '$liu'and '$endtime' and 工程id='$gcid' ";
										$result = $conn->query($sql);
										while($row = $result->fetch_assoc()) {
