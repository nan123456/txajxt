...
//				var cqbah=document.getElementById("cqbah");
//				var nx=document.getElementById("nx");
//				var zzdw=document.getElementById("zzdw");
//				var xh=document.getElementById("xh");
//				var jwd=document.getElementById("jwd");
//				var wcfw=document.getElementById("wcfw");
//				var zdqzj=document.getElementById("zdqzj");
//				var sjzd=document.getElementById("sjzd");
//				var zdqz=document.getElementById("zdqz");
//				var bglz=document.getElementById("bglz");
...
//							alert(id);
//							var sbid=sbid;
//							var sbiddz=document.getElementById("sbid").value;
//							alert (sbid);
//							alert (sbzt);
							$.ajax({
			        	url:'sbglsh.php',
